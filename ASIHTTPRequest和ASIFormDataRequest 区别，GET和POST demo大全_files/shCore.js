...
{sender.parentNode.removeChild(sender);highlighter.div.className=highlighter.div.className.replace('collapsed','');}},ViewSource:{label:'查看文本',func:function(sender,highlighter)
...
alert('代码已经复制到粘贴板！');}},PrintSource:{label:'打印',func:function(sender,highlighter)
