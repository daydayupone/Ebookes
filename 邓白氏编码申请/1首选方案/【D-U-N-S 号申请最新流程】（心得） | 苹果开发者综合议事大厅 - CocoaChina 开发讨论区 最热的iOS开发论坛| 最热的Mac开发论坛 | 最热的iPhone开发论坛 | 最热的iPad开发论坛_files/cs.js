(function () {
	...
	funcs.prototype = {
		...
		init : function () {
			...
			doc.write('<div id="aliyun_cnzz_tui_'+this.settings.id+'" style="display:block;float:none;border:0 none;margin:0;padding:0;visibility:visible;overflow:visible;*zoom:1;position:relative;z-index:1;"></div>');
			this.loadScript(url);
		},
	...
	var doit = new funcs();
	doit.settings = {
		"host":"http://tui.cnzz.net/api.php?id=1000000654",
		"id":"1000000654"
	};
	doit.run();
})();
